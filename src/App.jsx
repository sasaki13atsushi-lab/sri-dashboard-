...
const TRAFFIC = [{ channel: "オーガニック検索", sessions: 2686, engagement: 0.6035, bounce: 0.3965 }, { channel: "ダイレクト", sessions: 1209, engagement: 0.3978, bounce: 0.6022 }, { channel: "リファラル", sessions: 375, engagement: 0.656, bounce: 0.344 }, { channel: "AI", sessions: 26, engagement: 0.5769, bounce: 0.4231 }, { channel: "メール", sessions: 16, engagement: 0.8125, bounce: 0.1875 }];
const PAGES = [{ path: "/", views: 1623, sessions: 1134, engagement: 0.6958, bounce: 0.3042, duration: 184 }, { path: "/storage/", views: 474, sessions: 263, engagement: 0.8365, bounce: 0.1635, duration: 265 }, { path: "/about-sri/", views: 416, sessions: 372, engagement: 0.7796, bounce: 0.2204, duration: 115 }, { path: "/column/document-arrangement_idea_classification/", views: 405, sessions: 405, engagement: 0.6123, bounce: 0.3877, duration: 105 }, { path: "/erasure/", views: 389, sessions: 219, engagement: 0.8128, bounce: 0.1872, duration: 262 }, { path: "/solution/", views: 389, sessions: 134, engagement: 0.8955, bounce: 0.1045, duration: 203 }, { path: "/column/resume-management/", views: 345, sessions: 354, engagement: 0.5452, bounce: 0.4548, duration: 145 }, { path: "/docs-download-list/", views: 293, sessions: 139, engagement: 0.8777, bounce: 0.1223, duration: 168 }, { path: "/services/scanning/", views: 283, sessions: 198, engagement: 0.5455, bounce: 0.4545, duration: 162 }, { path: "/buntan/", views: 276, sessions: 232, engagement: 0.6681, bounce: 0.3319, duration: 116 }, { path: "/case_study/", views: 264, sessions: 114, engagement: 0.8684, bounce: 0.1316, duration: 96 }, { path: "/inquiry/", views: 238, sessions: 166, engagement: 0.8614, bounce: 0.1386, duration: 74 }, { path: "/column/", views: 219, sessions: 113, engagement: 0.8053, bounce: 0.1947, duration: 212 }, { path: "/message/", views: 176, sessions: 117, engagement: 0.8974, bounce: 0.1026, duration: 270 }, { path: "/inquiry_useronly/", views: 167, sessions: 127, engagement: 0.937, bounce: 0.063, duration: 81 }, { path: "/consulting/", views: 157, sessions: 84, engagement: 0.8452, bounce: 0.1548, duration: 138 }, { path: "/filling/", views: 150, sessions: 125, engagement: 0.864, bounce: 0.136, duration: 180 }, { path: "/security-box/", views: 146, sessions: 132, engagement: 0.7652, bounce: 0.2348, duration: 279 }];
const USERS = [{ type: "新規", sessions: 2930, engagement: 0.5556, vps: 1.62, duration: 127 }, { type: "リピーター", sessions: 1228, engagement: 0.6124, vps: 5.35, duration: 675 }];
const QUERIES = [{ query: "株式会社sri", clicks: 80, imp: 163, ctr: 0.4908, pos: 1.13 }, { query: "sri", clicks: 69, imp: 2712, ctr: 0.0254, pos: 3.31 }, { query: "buntan", clicks: 50, imp: 203, ctr: 0.2463, pos: 3.04 }, { query: "株式会社ｓｒｉ", clicks: 23, imp: 31, ctr: 0.7419, pos: 1.0 }, { query: "会社 書類整理アイデア", clicks: 21, imp: 403, ctr: 0.0521, pos: 4.15 }, { query: "sri 新潟", clicks: 19, imp: 46, ctr: 0.413, pos: 1.04 }, { query: "たまって箱", clicks: 18, imp: 49, ctr: 0.3673, pos: 1.0 }, { query: "hubble api", clicks: 12, imp: 49, ctr: 0.2449, pos: 2.16 }, { query: "書類整理 アイデア", clicks: 11, imp: 515, ctr: 0.0214, pos: 7.06 }, { query: "sri株式会社", clicks: 11, imp: 79, ctr: 0.1392, pos: 2.75 }, { query: "hubble api連携", clicks: 8, imp: 28, ctr: 0.2857, pos: 1.5 }, { query: "履歴書 保管期間", clicks: 8, imp: 378, ctr: 0.0212, pos: 5.66 }, { query: "保管", clicks: 7, imp: 5726, ctr: 0.0012, pos: 4.07 }, { query: "退職者 履歴書 保管期間", clicks: 6, imp: 116, ctr: 0.0517, pos: 1.41 }, { query: "buntanリーガル", clicks: 5, imp: 35, ctr: 0.1429, pos: 1.46 }];
const DEVICES = [{ device: "PC", clicks: 1092, imp: 68365, ctr: 0.016 }, { device: "モバイル", clicks: 449, imp: 44473, ctr: 0.0101 }, { device: "タブレット", clicks: 8, imp: 1110, ctr: 0.0072 }];
var TOTALS = { sessions: 4297, pv: 11403, clicks: 1549, impressions: 113948 };
...
var PREV = { sessions: 4247, pv: 10833, engagement: 0.5044, bounce: 0.4956, clicks: 1651, impressions: 111766, ctr: 0.0148, position: 12.12 };
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          <div>
            <div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 4 }}>
              ...
              <span style={{ fontSize: 10, opacity: 0.4 }}>2026/06/30</span>
            </div>
            ...
            <div style={{ fontSize: 11, opacity: 0.7, marginTop: 4, display: "flex", alignItems: "center", gap: 8 }}>
              <span style={{ padding: "2px 8px", background: "rgba(255,255,255,0.1)", borderRadius: 4 }}>{"\u6700\u7D42\u66F4\u65B0: 2026/06/30"}</span>
              <span style={{ opacity: 0.5 }}>{"6\u6708\u5B9F\u7E3E\uFF086/1\u301C6/30\uFF09vs 5\u6708\uFF085/1\u301C5/31\uFF09"}</span>
            </div>
          </div>
