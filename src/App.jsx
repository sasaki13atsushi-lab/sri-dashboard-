...
const TRAFFIC = [{ channel: "\u30AA\u30FC\u30AC\u30CB\u30C3\u30AF\u691C\u7D22", sessions: 2506, engagement: 0.5914, bounce: 0.4086 }, { channel: "\u30C0\u30A4\u30EC\u30AF\u30C8", sessions: 1456, engagement: 0.3489, bounce: 0.6511 }, { channel: "\u30EA\u30D5\u30A1\u30E9\u30EB", sessions: 331, engagement: 0.6888, bounce: 0.3112 }, { channel: "AI", sessions: 12, engagement: 0.5833, bounce: 0.4167 }, { channel: "\u52D5\u753B", sessions: 11, engagement: 0.8182, bounce: 0.1818 }, { channel: "\u30E1\u30FC\u30EB", sessions: 9, engagement: 0.6667, bounce: 0.3333 }];
const PAGES = [{ path: "/", views: 1547, sessions: 1055, engagement: 0.7213, bounce: 0.2787, duration: 184 }, { path: "/column/document-arrangement_idea_classification", views: 320, sessions: 310, engagement: 0.5871, bounce: 0.4129, duration: 103 }, { path: "/about-sri", views: 280, sessions: 210, engagement: 0.7762, bounce: 0.2238, duration: 137 }, { path: "/column/resume-management/", views: 235, sessions: 227, engagement: 0.4802, bounce: 0.5198, duration: 117 }, { path: "/storage/", views: 234, sessions: 121, engagement: 0.8678, bounce: 0.1322, duration: 218 }, { path: "/column/document-arrangement_idea_classification/", views: 233, sessions: 234, engagement: 0.5641, bounce: 0.4359, duration: 94 }, { path: "/erasure/", views: 231, sessions: 106, engagement: 0.8208, bounce: 0.1792, duration: 245 }, { path: "/about-sri/", views: 212, sessions: 170, engagement: 0.8294, bounce: 0.1706, duration: 156 }, { path: "/about_us", views: 188, sessions: 141, engagement: 0.9078, bounce: 0.0922, duration: 54 }, { path: "/message/", views: 176, sessions: 79, engagement: 0.8861, bounce: 0.1139, duration: 271 }, { path: "/buntan", views: 174, sessions: 145, engagement: 0.7172, bounce: 0.2828, duration: 117 }, { path: "/buntan/", views: 168, sessions: 116, engagement: 0.681, bounce: 0.319, duration: 320 }, { path: "/column/what_is_contract-management", views: 168, sessions: 162, engagement: 0.1728, bounce: 0.8272, duration: 31 }, { path: "/column/resume-management", views: 157, sessions: 170, engagement: 0.4941, bounce: 0.5059, duration: 112 }, { path: "/consulting/", views: 145, sessions: 67, engagement: 0.8955, bounce: 0.1045, duration: 186 }, { path: "/solution/business/", views: 143, sessions: 22, engagement: 0.9091, bounce: 0.0909, duration: 389 }, { path: "/inquiry/", views: 130, sessions: 87, engagement: 0.8506, bounce: 0.1494, duration: 62 }, { path: "/services/scanning/", views: 123, sessions: 51, engagement: 0.8235, bounce: 0.1765, duration: 416 }];
const USERS = [{ type: "\u65B0\u898F", sessions: 3065, engagement: 0.4998, vps: 1.63, duration: 119 }, { type: "\u30EA\u30D4\u30FC\u30BF\u30FC", sessions: 1127, engagement: 0.6318, vps: 5.40, duration: 704 }];
const QUERIES = [{ query: "\u682A\u5F0F\u4F1A\u793Esri", clicks: 79, imp: 170, ctr: 0.4647, pos: 1.09 }, { query: "sri", clicks: 76, imp: 2786, ctr: 0.0273, pos: 3.61 }, { query: "buntan", clicks: 56, imp: 238, ctr: 0.2353, pos: 2.81 }, { query: "\u4F1A\u793E \u66F8\u985E\u6574\u7406\u30A2\u30A4\u30C7\u30A2", clicks: 35, imp: 502, ctr: 0.0697, pos: 3.68 }, { query: "\u66F8\u985E\u6574\u7406 \u30A2\u30A4\u30C7\u30A2", clicks: 10, imp: 499, ctr: 0.02, pos: 5.95 }, { query: "\u66F8\u985E\u6574\u7406 \u304A\u3059\u3059\u3081", clicks: 8, imp: 225, ctr: 0.0356, pos: 6.24 }, { query: "\u66F8\u985E \u6574\u7406\u65B9\u6CD5", clicks: 6, imp: 101, ctr: 0.0594, pos: 8.1 }, { query: "\u4FDD\u7BA1", clicks: 5, imp: 5694, ctr: 0.0009, pos: 4.8 }, { query: "\u5C65\u6B74\u66F8 \u4FDD\u7BA1\u671F\u9593", clicks: 5, imp: 393, ctr: 0.0127, pos: 5.63 }, { query: "\u6587\u66F8\u7BA1\u7406\u53F0\u5E33", clicks: 5, imp: 204, ctr: 0.0245, pos: 16.86 }, { query: "\u4F1A\u793E \u66F8\u985E\u6574\u7406 \u30A2\u30A4\u30C7\u30A2", clicks: 4, imp: 326, ctr: 0.0123, pos: 18.62 }, { query: "\u6574\u7406 \u6574\u9813 \u9055\u3044", clicks: 4, imp: 720, ctr: 0.0056, pos: 7.21 }];
const DEVICES = [{ device: "PC", clicks: 1113, imp: 62509, ctr: 0.0178 }, { device: "\u30E2\u30D0\u30A4\u30EB", clicks: 546, imp: 48338, ctr: 0.0113 }, { device: "\u30BF\u30D6\u30EC\u30C3\u30C8", clicks: 14, imp: 1176, ctr: 0.0119 }];
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          <div>
            <div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 4 }}>
              ...
              <span style={{ fontSize: 10, opacity: 0.4 }}>2026/06/03</span>
            </div>
