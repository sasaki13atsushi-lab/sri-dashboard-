...
const TRAFFIC = [{ channel: "オーガニック検索", sessions: 3274, engagement: 0.621, bounce: 0.379 }, { channel: "ダイレクト", sessions: 1425, engagement: 0.3677, bounce: 0.6323 }, { channel: "リファラル", sessions: 410, engagement: 0.6829, bounce: 0.3171 }, { channel: "AI", sessions: 30, engagement: 0.6, bounce: 0.4 }, { channel: "メール", sessions: 29, engagement: 0.8276, bounce: 0.1724 }];
const PAGES = [{ path: "/", views: 1830, sessions: 1221, engagement: 0.6814, bounce: 0.3186, duration: 222 }, { path: "/column/", views: 465, sessions: 199, engagement: 0.804, bounce: 0.196, duration: 266 }, { path: "/column/resume-management/", views: 408, sessions: 407, engagement: 0.5848, bounce: 0.4152, duration: 139 }, { path: "/column/document-storage-period_table/", views: 386, sessions: 364, engagement: 0.7253, bounce: 0.2747, duration: 155 }, { path: "/about-sri/", views: 384, sessions: 342, engagement: 0.807, bounce: 0.193, duration: 131 }, { path: "/column/document-arrangement_idea_classification/", views: 357, sessions: 361, engagement: 0.59, bounce: 0.41, duration: 96 }, { path: "/storage/", views: 312, sessions: 247, engagement: 0.6964, bounce: 0.3036, duration: 200 }, { path: "/storage-outsourcing/hozon-kikan/", views: 300, sessions: 292, engagement: 0.7329, bounce: 0.2671, duration: 163 }, { path: "/security-box/", views: 220, sessions: 144, engagement: 0.7986, bounce: 0.2014, duration: 322 }, { path: "/buntan/", views: 217, sessions: 194, engagement: 0.6392, bounce: 0.3608, duration: 98 }, { path: "/inquiry/", views: 216, sessions: 161, engagement: 0.8385, bounce: 0.1615, duration: 100 }, { path: "/erasure/", views: 196, sessions: 148, engagement: 0.7568, bounce: 0.2432, duration: 204 }, { path: "/inquiry_useronly/", views: 179, sessions: 129, engagement: 0.9535, bounce: 0.0465, duration: 102 }, { path: "/docs-download-list/", views: 142, sessions: 112, engagement: 0.8929, bounce: 0.1071, duration: 70 }, { path: "/solution/", views: 136, sessions: 79, engagement: 0.8228, bounce: 0.1772, duration: 116 }, { path: "/case_study/", views: 135, sessions: 102, engagement: 0.8627, bounce: 0.1373, duration: 81 }, { path: "/message/", views: 131, sessions: 101, engagement: 0.8317, bounce: 0.1683, duration: 229 }, { path: "/docs-download-list/wp_document01/", views: 125, sessions: 124, engagement: 0.2177, bounce: 0.7823, duration: 17 }];
const USERS = [{ type: "新規", sessions: 3884, engagement: 0.5548, vps: 1.43, duration: 122 }, { type: "リピーター", sessions: 1233, engagement: 0.5953, vps: 4.17, duration: 638 }];
const QUERIES = [{ query: "sri", clicks: 74, imp: 2796, ctr: 0.0265, pos: 3.28 }, { query: "株式会社sri", clicks: 70, imp: 141, ctr: 0.4965, pos: 1.05 }, { query: "buntan", clicks: 50, imp: 184, ctr: 0.2717, pos: 2.60 }, { query: "sri 新潟", clicks: 22, imp: 50, ctr: 0.44, pos: 1.04 }, { query: "sri株式会社", clicks: 16, imp: 70, ctr: 0.2286, pos: 2.44 }, { query: "株式会社sri 新潟", clicks: 14, imp: 30, ctr: 0.4667, pos: 1.0 }, { query: "株式会社ｓｒｉ", clicks: 13, imp: 25, ctr: 0.52, pos: 1.0 }, { query: "会社 書類整理アイデア", clicks: 11, imp: 417, ctr: 0.0264, pos: 4.24 }, { query: "たまって箱", clicks: 9, imp: 36, ctr: 0.25, pos: 1.03 }, { query: "書類整理 アイデア", clicks: 9, imp: 545, ctr: 0.0165, pos: 6.73 }, { query: "保管", clicks: 8, imp: 5697, ctr: 0.0014, pos: 3.92 }, { query: "履歴書 保管期間", clicks: 8, imp: 392, ctr: 0.0204, pos: 5.98 }, { query: "履歴書保管期間", clicks: 7, imp: 83, ctr: 0.0843, pos: 1.54 }, { query: "履歴書 保存期間", clicks: 6, imp: 155, ctr: 0.0387, pos: 3.88 }, { query: "退職者 履歴書 保管期間", clicks: 5, imp: 132, ctr: 0.0379, pos: 1.90 }];
const DEVICES = [{ device: "PC", clicks: 1050, imp: 68702, ctr: 0.0153 }, { device: "モバイル", clicks: 494, imp: 45584, ctr: 0.0108 }, { device: "タブレット", clicks: 11, imp: 1197, ctr: 0.0092 }];
var TOTALS = { sessions: 5264, pv: 10814, clicks: 1555, impressions: 115483 };
...
var PREV = { sessions: 4726, pv: 14786, engagement: 0.526, bounce: 0.474, clicks: 1736, impressions: 120557, ctr: 0.0144, position: 11.56 };
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          <div>
            <div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 4 }}>
              ...
              <span style={{ fontSize: 10, opacity: 0.4 }}>2026/07/14</span>
            </div>
            ...
            <div style={{ fontSize: 11, opacity: 0.7, marginTop: 4, display: "flex", alignItems: "center", gap: 8 }}>
              <span style={{ padding: "2px 8px", background: "rgba(255,255,255,0.1)", borderRadius: 4 }}>{"\u6700\u7D42\u66F4\u65B0: 2026/07/14"}</span>
