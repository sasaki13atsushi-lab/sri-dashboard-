...
const TRAFFIC = [{ channel: "オーガニック検索", sessions: 4708, engagement: 0.6599, bounce: 0.3401 }, { channel: "ダイレクト", sessions: 1522, engagement: 0.3515, bounce: 0.6485 }, { channel: "リファラル", sessions: 295, engagement: 0.6746, bounce: 0.3254 }, { channel: "AI", sessions: 61, engagement: 0.5902, bounce: 0.4098 }, { channel: "SNS", sessions: 4, engagement: 0.0, bounce: 1.0 }];
const PAGES = [{ path: "/column/document-storage-period_table/", views: 2011, sessions: 1867, engagement: 0.7193, bounce: 0.2807, duration: 186 }, { path: "/", views: 1136, sessions: 979, engagement: 0.6374, bounce: 0.3626, duration: 109 }, { path: "/column/resume-management/", views: 547, sessions: 561, engagement: 0.6292, bounce: 0.3708, duration: 122 }, { path: "/about-sri/", views: 402, sessions: 343, engagement: 0.8367, bounce: 0.1633, duration: 163 }, { path: "/inquiry/", views: 335, sessions: 240, engagement: 0.8583, bounce: 0.1417, duration: 69 }, { path: "/storage-outsourcing/hozon-kikan/", views: 304, sessions: 299, engagement: 0.7692, bounce: 0.2308, duration: 189 }, { path: "/column/document-arrangement_idea_classification/", views: 221, sessions: 226, engagement: 0.6283, bounce: 0.3717, duration: 84 }, { path: "/security-box/", views: 201, sessions: 120, engagement: 0.75, bounce: 0.25, duration: 253 }, { path: "/column/how-to-dispose-of-documents/", views: 196, sessions: 192, engagement: 0.2031, bounce: 0.7969, duration: 39 }, { path: "/storage/", views: 196, sessions: 168, engagement: 0.7798, bounce: 0.2202, duration: 193 }, { path: "/buntan/", views: 180, sessions: 159, engagement: 0.6855, bounce: 0.3145, duration: 112 }, { path: "/box/sanko/", views: 171, sessions: 95, engagement: 0.7053, bounce: 0.2947, duration: 308 }, { path: "/docs-download-list/", views: 168, sessions: 114, engagement: 0.8947, bounce: 0.1053, duration: 146 }, { path: "/about_us/", views: 131, sessions: 125, engagement: 0.84, bounce: 0.16, duration: 61 }, { path: "/case_study/", views: 128, sessions: 88, engagement: 0.9432, bounce: 0.0568, duration: 27 }, { path: "/inquiry_useronly/", views: 120, sessions: 110, engagement: 0.8909, bounce: 0.1091, duration: 48 }, { path: "/message/", views: 118, sessions: 111, engagement: 0.8829, bounce: 0.1171, duration: 98 }, { path: "/erasure/", views: 116, sessions: 111, engagement: 0.7117, bounce: 0.2883, duration: 197 }];
const USERS = [{ type: "新規", sessions: 5153, engagement: 0.6299, vps: 1.41, duration: 154 }, { type: "リピーター", sessions: 1243, engagement: 0.5229, vps: 1.92, duration: 318 }];
const QUERIES = [{ query: "株式会社sri", clicks: 103, imp: 187, ctr: 0.5508, pos: 1.01 }, { query: "sri", clicks: 76, imp: 2410, ctr: 0.0315, pos: 2.72 }, { query: "buntan", clicks: 38, imp: 142, ctr: 0.2676, pos: 2.46 }, { query: "保存期間 早見表", clicks: 26, imp: 224, ctr: 0.1161, pos: 3.29 }, { query: "株式会社ｓｒｉ", clicks: 22, imp: 40, ctr: 0.55, pos: 1.05 }, { query: "sri 新潟", clicks: 20, imp: 38, ctr: 0.5263, pos: 1.0 }, { query: "履歴書 保管期間", clicks: 14, imp: 344, ctr: 0.0407, pos: 5.99 }, { query: "sri株式会社", clicks: 13, imp: 104, ctr: 0.125, pos: 1.38 }, { query: "たまって箱", clicks: 12, imp: 32, ctr: 0.375, pos: 1.09 }, { query: "会社 書類整理アイデア", clicks: 10, imp: 496, ctr: 0.0202, pos: 5.97 }, { query: "保存", clicks: 9, imp: 7373, ctr: 0.0012, pos: 6.09 }, { query: "履歴書 保管義務", clicks: 8, imp: 68, ctr: 0.1176, pos: 1.91 }, { query: "書類整理 アイデア", clicks: 8, imp: 611, ctr: 0.0131, pos: 6.70 }, { query: "5年保管 数え方 2026", clicks: 6, imp: 49, ctr: 0.1224, pos: 3.06 }, { query: "履歴書 保存期間", clicks: 6, imp: 153, ctr: 0.0392, pos: 4.53 }];
const DEVICES = [{ device: "PC", clicks: 1246, imp: 69213, ctr: 0.018 }, { device: "モバイル", clicks: 494, imp: 55983, ctr: 0.0088 }, { device: "タブレット", clicks: 11, imp: 1338, ctr: 0.0082 }];
var TOTALS = { sessions: 6670, pv: 9772, clicks: 1751, impressions: 126534 };
...
function buildImprovementsFrom(pagesData, queriesData) {
  ...
  sorted.slice(0, 4).forEach(function(p) {
    ...
    if (p.path.includes("contract-management")) {
      ...
      // Override issues with specific analysis
      issues = [
        "\u76F4\u5E30\u7387: " + b + "% \u2015 361\u30BB\u30C3\u30B7\u30E7\u30F3\u4E2D41%\u304C\u4ED6\u30DA\u30FC\u30B8\u3092\u898B\u305A\u306B\u96E2\u8131\u3002\u30B3\u30E9\u30E0\u304B\u3089\u30B5\u30FC\u30D3\u30B9\u30DA\u30FC\u30B8\u3078\u306E\u5C0E\u7DDA\u304C\u5F31\u3044",
        "\u6EDE\u5728\u6642\u9593: " + p.duration + "\u79D2 \u2015 \u30B3\u30E9\u30E0\u8A18\u4E8B\u3068\u3057\u3066\u306F\u77ED\u304F\u3001\u30E6\u30FC\u30B6\u30FC\u304C\u8A18\u4E8B\u3092\u5341\u5206\u306B\u8AAD\u307E\u305A\u306B\u96E2\u8131\u3057\u3066\u3044\u308B\u53EF\u80FD\u6027\u304C\u9AD8\u3044",
        "\u30A8\u30F3\u30B2\u30FC\u30B8\u30E1\u30F3\u30C8\u7387: " + e + "% \u2015 \u30B5\u30A4\u30C8\u5E73\u5747" + ae + "%\u3092\u4E0B\u56DE\u308A\u3001\u691C\u7D22\u610F\u56F3\u3068\u30B3\u30F3\u30C6\u30F3\u30C4\u306E\u30DF\u30B9\u30DE\u30C3\u30C1\u304C\u758E\u308F\u308C\u308B",
        "PV/\u30BB\u30C3\u30B7\u30E7\u30F3\u306E\u4F4E\u4E0B \u2015 \u30B5\u30A4\u30C8\u5168\u4F53\u3067PV\u304C\u524D\u6708\u6BD4-26.9%\u3002\u672C\u30DA\u30FC\u30B8\u304B\u3089\u306E\u56DE\u904A\u4E0D\u8DB3\u304C\u4E00\u56E0",
        "\u30BB\u30C3\u30B7\u30E7\u30F3: " + p.sessions + "\uFF08" + p.views + "PV\uFF09\u2015 \u30C8\u30E9\u30D5\u30A3\u30C3\u30AF\u304C\u5927\u304D\u3044\u305F\u3081\u6539\u5584\u306E\u30A4\u30F3\u30D1\u30AF\u30C8\u5927",
      ];
      actions = [
        "\u8A18\u4E8B\u672B\u5C3E\uFF08\u307E\u3068\u3081\u30BB\u30AF\u30B7\u30E7\u30F3\u306E\u5F8C\uFF09\u306B\u300CSRI\u306E\u6587\u66F8\u7BA1\u7406\u30B5\u30FC\u30D3\u30B9\u306E\u8A73\u7D30 \u2192 /buntan\u300DCTA\u30D0\u30CA\u30FC\u3092\u65B0\u898F\u8A2D\u7F6E",
        "\u30B5\u30A4\u30C9\u30D0\u30FC\u307E\u305F\u306F\u8A18\u4E8B\u53F3\u30AB\u30E9\u30E0\u306B\u300C\u95A2\u9023\u30B3\u30E9\u30E0\uFF1A\u5C65\u6B74\u66F8\u306E\u4FDD\u7BA1\u671F\u9593\u300D\u300C\u66F8\u985E\u4FDD\u5B58\u671F\u9593\u4E00\u89A7\u300D\u300C\u5951\u7D04\u7BA1\u7406\u306E\u57FA\u672C\u300D\u3078\u306E\u30EA\u30F3\u30AF\u30AB\u30FC\u30C9\u30923\u679A\u8A2D\u7F6E",
        "\u8A18\u4E8B\u5192\u982D\u306B\u300C\u3053\u306E\u8A18\u4E8B\u306E\u30DD\u30A4\u30F3\u30C8\u300D\u30DC\u30C3\u30AF\u30B9\u3092\u8FFD\u52A0\u3057\u3001\u7D50\u8AD6\u3092\u5148\u306B\u63D0\u793A\u3057\u3066\u96E2\u8131\u3092\u9632\u6B62",
        "\u8A18\u4E8B\u672C\u6587\u30925,000\u5B57\u4EE5\u4E0A\u306B\u62E1\u5145\u3002\u5177\u4F53\u7684\u306A\u30C1\u30A7\u30C3\u30AF\u30EA\u30B9\u30C8\u3084\u4E8B\u4F8B\u5199\u771F\u3092\u8FFD\u52A0\u3057\u6EDE\u5728\u6642\u9593\u3092\u5EF6\u3070\u3059",
        "/buntan\u3001/storage\u3001/consulting\u3001/erasure\u306E\u5404\u30DA\u30FC\u30B8\u304B\u3089\u672C\u30B3\u30E9\u30E0\u3078\u306E\u5185\u90E8\u30EA\u30F3\u30AF\u30925\u672C\u4EE5\u4E0A\u8FFD\u52A0\u3057\u30DA\u30FC\u30B8\u6A29\u5A01\u6027\u3092\u5411\u4E0A",
      ];
    } else {
      actions = [
...
var PREV = { sessions: 6342, pv: 11629, engagement: 0.5836, bounce: 0.4164, clicks: 1647, impressions: 120458, ctr: 0.0137, position: 11.10 };
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          <div>
            <div style={{ display: "flex", gap: 8, alignItems: "center", marginBottom: 4 }}>
              ...
              <span style={{ fontSize: 10, opacity: 0.4 }}>2026/08/27</span>
            </div>
            ...
            <div style={{ fontSize: 11, opacity: 0.7, marginTop: 4, display: "flex", alignItems: "center", gap: 8 }}>
              <span style={{ padding: "2px 8px", background: "rgba(255,255,255,0.1)", borderRadius: 4 }}>{"\u6700\u7D42\u66F4\u65B0: 2026/08/27"}</span>
              <span style={{ opacity: 0.5 }}>{"\u76F4\u8FD130\u65E5\u9593 vs \u524D\u670830\u65E5\u9593"}</span>
            </div>
          </div>
